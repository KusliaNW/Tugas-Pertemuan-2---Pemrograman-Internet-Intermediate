...
<html lang="en">
  <head>
    ...
    <title>Penjualan Bahan Bangunan</title>
...
<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">Penjualan Bahan Bangunan</a>
...
<div class="panel-body">
    ...
    <a href="cetak.php" target="_blank" class="btn btn-primary btn-sm">CETAK DATA</a>
</div>
<!--End: Panel-body-->
